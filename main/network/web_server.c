...
static esp_err_t root_get_handler(httpd_req_t *req)
{
    const char *html =
        ...
        "<div class='pad'>"
        "<button id='btn-forward' class='btn circle up' onpointerdown=\"return startDrive('forward', event)\" onpointerup=\"return stopDrive(event)\" onpointercancel=\"return stopDrive(event)\" onpointerleave=\"return stopDrive(event)\">Up</button>"
        "<button id='btn-left' class='btn circle left' onpointerdown=\"return startSteer('left', event)\" onpointerup=\"return stopSteer(event)\" onpointercancel=\"return stopSteer(event)\" onpointerleave=\"return stopSteer(event)\">Left</button>"
        "<button id='btn-center' class='btn circle center' onclick=\"return clickCenter(event)\">Center</button>"
        "<button id='btn-right' class='btn circle right' onpointerdown=\"return startSteer('right', event)\" onpointerup=\"return stopSteer(event)\" onpointercancel=\"return stopSteer(event)\" onpointerleave=\"return stopSteer(event)\">Right</button>"
        "<button id='btn-backward' class='btn circle down' onpointerdown=\"return startDrive('backward', event)\" onpointerup=\"return stopDrive(event)\" onpointercancel=\"return stopDrive(event)\" onpointerleave=\"return stopDrive(event)\">Down</button>"
        "</div><br><br>"
        "<button id='btn-stop' class='btn stop' onclick=\"return clickStop(event)\">Stop</button>"
